...
public class oggpack_buffer {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        opusfile_h.C_LONG.withName("endbyte"),
        opusfile_h.C_INT.withName("endbit"),
        opusfile_h.C_POINTER.withName("buffer"),
        opusfile_h.C_POINTER.withName("ptr"),
        opusfile_h.C_LONG.withName("storage"),
