...
public class opusfile_h extends opusfile_h$shared {
    ...
    static final SymbolLookup SYMBOL_LOOKUP = SymbolLookup.libraryLookup(System.mapLibraryName(" opusfile -l opus -l ogg"), LIBRARY_ARENA)
    ...
    private static class opus_multistream_surround_encoder_get_size {
        ...
        public static final MemorySegment ADDR = SYMBOL_LOOKUP.findOrThrow("opus_multistream_surround_encoder_get_size");
     ...
     * }
     */
    public static MemorySegment opus_multistream_encoder_create(int Fs, int channels, int streams, int coupled_streams, MemorySegment mapping, int application, MemorySegment error) {
        var mh$ = opus_multistream_encoder_create.HANDLE;
        try {
            if (TRACE_DOWNCALLS) {
                traceDowncall("opus_multistream_encoder_create", Fs, channels, streams, coupled_streams, mapping, application, error);
            }
     ...
     * }
     */
    public static MemorySegment opus_multistream_surround_encoder_create(int Fs, int channels, int mapping_family, MemorySegment streams, MemorySegment coupled_streams, MemorySegment mapping, int application, MemorySegment error) {
        var mh$ = opus_multistream_surround_encoder_create.HANDLE;
        try {
            if (TRACE_DOWNCALLS) {
                traceDowncall("opus_multistream_surround_encoder_create", Fs, channels, mapping_family, streams, coupled_streams, mapping, application, error);
            }
            return (MemorySegment)mh$.invokeExact(Fs, channels, mapping_family, streams, coupled_streams, mapping, application, error);
        } catch (Error | RuntimeException ex) {
           throw ex;
        } catch (Throwable ex$) {
           throw new AssertionError("should not reach here", ex$);
     ...
     * }
     */
    public static int opus_multistream_encoder_init(MemorySegment st, int Fs, int channels, int streams, int coupled_streams, MemorySegment mapping, int application) {
        var mh$ = opus_multistream_encoder_init.HANDLE;
        try {
            if (TRACE_DOWNCALLS) {
                traceDowncall("opus_multistream_encoder_init", st, Fs, channels, streams, coupled_streams, mapping, application);
            }
     ...
     * }
     */
    public static int opus_multistream_surround_encoder_init(MemorySegment st, int Fs, int channels, int mapping_family, MemorySegment streams, MemorySegment coupled_streams, MemorySegment mapping, int application) {
        var mh$ = opus_multistream_surround_encoder_init.HANDLE;
        try {
            if (TRACE_DOWNCALLS) {
                traceDowncall("opus_multistream_surround_encoder_init", st, Fs, channels, mapping_family, streams, coupled_streams, mapping, application);
            }
            return (int)mh$.invokeExact(st, Fs, channels, mapping_family, streams, coupled_streams, mapping, application);
        } catch (Error | RuntimeException ex) {
           throw ex;
        } catch (Throwable ex$) {
           throw new AssertionError("should not reach here", ex$);
     ...
     * }
     */
    public static int opus_multistream_encode(MemorySegment st, MemorySegment pcm, int frame_size, MemorySegment data, int max_data_bytes) {
     ...
     * }
     */
    public static int opus_multistream_encode24(MemorySegment st, MemorySegment pcm, int frame_size, MemorySegment data, int max_data_bytes) {
     ...
     * }
     */
    public static int opus_multistream_encode_float(MemorySegment st, MemorySegment pcm, int frame_size, MemorySegment data, int max_data_bytes) {
    ...
    public static class opus_multistream_encoder_ctl {
        ...
        private opus_multistream_encoder_ctl(MethodHandle handle, FunctionDescriptor descriptor, MethodHandle spreader) {
            this.handle = handle;
            this.descriptor = descriptor;
            this.spreader = spreader;
        }
     ...
     * }
     */
    public static MemorySegment opus_multistream_decoder_create(int Fs, int channels, int streams, int coupled_streams, MemorySegment mapping, MemorySegment error) {
        var mh$ = opus_multistream_decoder_create.HANDLE;
        try {
            if (TRACE_DOWNCALLS) {
                traceDowncall("opus_multistream_decoder_create", Fs, channels, streams, coupled_streams, mapping, error);
            }
     ...
     * }
     */
    public static int opus_multistream_decoder_init(MemorySegment st, int Fs, int channels, int streams, int coupled_streams, MemorySegment mapping) {
     ...
     * }
     */
    public static int opus_multistream_decode(MemorySegment st, MemorySegment data, int len, MemorySegment pcm, int frame_size, int decode_fec) {
     ...
     * }
     */
    public static int opus_multistream_decode24(MemorySegment st, MemorySegment data, int len, MemorySegment pcm, int frame_size, int decode_fec) {
     ...
     * }
     */
    public static int opus_multistream_decode_float(MemorySegment st, MemorySegment data, int len, MemorySegment pcm, int frame_size, int decode_fec) {
    ...
    public static class opus_multistream_decoder_ctl {
        ...
        private opus_multistream_decoder_ctl(MethodHandle handle, FunctionDescriptor descriptor, MethodHandle spreader) {
            this.handle = handle;
            this.descriptor = descriptor;
            this.spreader = spreader;
        }
     ...
     * }
     */
    public static MemorySegment op_freopen(MemorySegment _cb, MemorySegment _path, MemorySegment _mode, MemorySegment _stream) {
     ...
     * }
     */
    public static MemorySegment op_open_callbacks(MemorySegment _stream, MemorySegment _cb, MemorySegment _initial_data, long _initial_bytes, MemorySegment _error) {
     ...
     * }
     */
    public static MemorySegment op_test_callbacks(MemorySegment _stream, MemorySegment _cb, MemorySegment _initial_data, long _initial_bytes, MemorySegment _error) {
     ...
     * Function descriptor for:
     * {@snippet lang=c :
     * long long op_raw_tell(const OggOpusFile *_of)
     * }
     */
    ...
    public static MemorySegment __FILEW__() {
        class Holder {
            static final MemorySegment __FILEW__
                = opusfile_h.LIBRARY_ARENA.allocateFrom("j");
        }
    ...
    public static MemorySegment _CRT_INTERNAL_STDIO_SYMBOL_PREFIX() {
        class Holder {
            static final MemorySegment _CRT_INTERNAL_STDIO_SYMBOL_PREFIX
                = opusfile_h.LIBRARY_ARENA.allocateFrom("");
        }
